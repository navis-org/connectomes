...
class NeuPrintMeshSource(MeshSource):
    def __init__(self, client):
        self.client = client

    def get(self, x, lod=1, **kwargs):
        """Fetch meshes for given neurons.
        ...
        return neu.fetch_mesh_neuron(x, client=self.client, lod=lod, **kwargs)
